...
from gc.core.Miner import Miner
from gc.core.TransactionPool import TransactionPool
from gc.core.misc.helper import parse_qaddress
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('gc.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('gc.core.Miner.Block.create')
