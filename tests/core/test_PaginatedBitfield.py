...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, set_gc_dir
...
class TestPaginatedBitfield(TestCase):
    ...
    @patch('gc.core.config.DevConfig.ots_tracking_per_page', new_callable=PropertyMock, return_value=1024)
    @patch('gc.core.config.DevConfig.ots_bitfield_size', new_callable=PropertyMock)
