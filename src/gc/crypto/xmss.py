...
from pygclib import pygclib
from pygclib.pygclib import bin2hstr, getRandomSeed, str2bin, bin2mnemonic, mnemonic2bin  # noqa
from pygclib.pygclib import XmssFast, gcDescriptor

hash_functions = {
    "shake128": pygclib.SHAKE_128,
    "shake256": pygclib.SHAKE_256,
    "sha2_256": pygclib.SHA2_256
}
...
class XMSS(object):
    ...
    def from_extended_seed(extended_seed: bytes):
        ...
        descr = gcDescriptor.fromBytes(extended_seed[0:3])
        if descr.getSignatureType() != pygclib.XMSS:
    ...
    def __init__(self, _xmssfast):
        ...
        >>> from gc.crypto.doctest_data import *
