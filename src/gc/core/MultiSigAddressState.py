...
from pygclib.pygclib import gcHelper, hstr2bin, sha2_256
...
class MultiSigAddressState(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = gc_pb2.MultiSigAddressState()
    ...
    def pbdata(self):
        ...
        :rtype: gc_pb2.MultiSigAddressState
        """
        return self._data
    ...
    def get_multi_sig_address_state(state: State,
        ...
        try:
            ...
            pbdata = gc_pb2.MultiSigAddressState()
